...
TO DO: write a mock to simulate data being fetched from the API
...
test('REPLACE_ME', async () => {
  //async means that we need to wait for something to happen (see await below)
...
//TO DO: If you found that easy, try writing simulating the instance where a user writes 'United' and gets back multiple countries
